...
public class GJVoidDepthFirst<A> implements GJVoidVisitor<A> {
    ...
    * f1 -> Identifier()
    */
   public void visit(ExtendsClass n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
   }
    ...
    * f2 -> PrimaryExpression()
    */
   public void visit(NotEqExpression n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
   }
    ...
    * f2 -> PrimaryExpression()
    */
   public void visit(AddExpression n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
   }
    ...
    * f2 -> PrimaryExpression()
    */
   public void visit(SubExpression n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
   }
    ...
    * f2 -> PrimaryExpression()
    */
   public void visit(MulExpression n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
   }
    ...
    * f0 -> <DOUBLE_LITERAL>
    */
   public void visit(DoubleLiteral n, A argu) {
      n.f0.accept(this, argu);
   }
