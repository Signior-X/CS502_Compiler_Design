/* Generated By:JavaCC: Do not edit this line. JTLang.java */
import syntaxtree.*;
import java.util.Vector;


public class JTLang implements JTLangConstants {
  ...
  static final public MainClass MainClass() throws ParseException {
   ...
   Token n32;
    ...
    n32 = jj_consume_token(RBRACE);
     ...
     {if (true) return new MainClass(n0,n2,n3,n5,n7,n9,n11,n13,n15,n17,n19,n21,n23,n24,n26,n28,n29,n31);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ExtendsClass ExtendsClass() throws ParseException {
   NodeToken n0;
   Token n1;
   Identifier n2;
    n1 = jj_consume_token(EXTENDS);
                  n0 = JTBToolkit.makeNodeToken(n1);
    n2 = Identifier();
     {if (true) return new ExtendsClass(n0,n2);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public NotEqExpression NotEqExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(NE);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new NotEqExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public AddExpression AddExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(PLUS);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new AddExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public SubExpression SubExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(49);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new SubExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public MulExpression MulExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(50);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new MulExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public DoubleLiteral DoubleLiteral() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(DOUBLE_LITERAL);
                         n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new DoubleLiteral(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ArrayLengthExpression ArrayLengthExpression() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(ARRAY_LENGTH);
                       n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ArrayLengthExpression(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ArrayLookupExression ArrayLookupExression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(RSQPAREN);
            n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new ArrayLookupExression(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }
  ...
  static private boolean jj_3R_51() {
    if (jj_scan_token(ARRAY_LENGTH)) return true;
    return false;
  }
  ...
  static public JTLangTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x200000,0x400000,0x400000,0x0,0x38000000,0x6002000,0x0,0x38000000,0x2000,0x6000000,0x6002000,0x2000000,0x81000200,0x81000200,0x0,0x0,0x1000000,0x80000200,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x1,0x800,0x840,0x4000,0x800,0x0,0x40,0x840,0x0,0x100f30,0x100f30,0x4000,0x400,0xb30,0x100000,0x4000,};
   }
  ...
  public JTLang(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JTLang(java.io.InputStream stream, String encoding) {
    ...
    token_source = new JTLangTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public JTLang(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public JTLang(JTLangTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(JTLangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
